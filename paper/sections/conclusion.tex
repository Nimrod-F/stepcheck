...
use. Several directions remain. We have already shown the architecture generalizes by
adding a CNCF Serverless Workflow frontend with no change to the analyses; further
frontends (SAM, CDK) would widen reach; richer effect and ownership information would sharpen the
