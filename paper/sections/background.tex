...
Consider the canonical order-processing workflow
\begin{center}\small
\texttt{CreateOrder} $\to$ \texttt{ReserveInventory} $\to$ \texttt{ChargeCard} $\to$ \texttt{ShipOrder},
\end{center}
which we use as a running example. It exhibits all four defect classes when edited
