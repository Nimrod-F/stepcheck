...
| Path | What |
|---|---|
| `paper/` | the paper sources and compiled PDF (kept out of the public repository while under review); the evaluation chart is generated by `eval/figures.ipynb` (matplotlib). |
